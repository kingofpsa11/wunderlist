    ...
    <div class="inner">
        <div class="top">
            <a class="detail-checkbox checkBox">
                <span>
                    <svg class="detail-check" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
        ...
        <div class="body">
            ...
            <div class="section section-item note">
                @component('components.detail.note')
            ...
            <div class="comments">
                <div class="comments-bottom">
                    <div class="last-comment hidden">
                        @if (isset($comments))
                            @component('components.detail.sectionItemComment', ['comments' => $comments, 'user' => Auth::user()])
