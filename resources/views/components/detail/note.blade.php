@php
    $class1 = isset($note) ? '' : 'hidden';
    $class2 = isset($note) ? 'hidden' : '';
@endphp
...
<div class="section-content top">
    <div class="section-title note-add {{ $class2 }}">Add a note...</div>
    <div class="note-body selectable {{ $class1 }}">
        <div class="display-view {{ $class1 }}">
            <span>
                @if (isset($note))
                    {{ $note->content }}
                @endif
        ...
        <div class="edit-view hidden">
            <div class="expandingArea">
                ...
                <textarea name="" id="" placeholder="Add a note..." style="font-size: 15px; line-height: 20px;"></textarea>
            </div>
        </div>
    </div>
</div>
