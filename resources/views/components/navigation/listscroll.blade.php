<div class="lists-scroll">
    ...
    <ul class="filter-collection">
        <li class="sidebarItem overdue active" rel="2">
            <a>
                ...
                <span class="overdue-count">6</span>
                <span class="count">6</span>
            </a>
        </li>
        <li class="sidebarItem overdue animate-down visible" rel="3">
            <a>
                <span class="list-icon">
        ...
        <li class="sidebarItem overdue animate-down visible" rel="4">
            <a>
                <span class="list-icon">
    ...
    <ul class="lists-collection">
        @foreach ($lists as $list)
            @component('components.navigation.sidebar.sidebaritem', ['list' => $list])
