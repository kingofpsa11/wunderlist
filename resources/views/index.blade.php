            ...
            <div id="list-toolbar">
                ...
                <div class="actionBar">
                    <div class="actionBar-top">
                        ...
                        @component('components.tasks.actionbar')
                    ...
                    <ol class="tasks">
                        <li class="taskItem" rel="">
                            <div class="taskItem-body">
                                ...
                                <div class="taskItem-titleWrapper"></div>
                                <span class="taskItem-duedate overdue"></span>
